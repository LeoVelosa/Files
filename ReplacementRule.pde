...
class ReplacementRule {
  ...
  private int maxAge;
  AgentFactory fac;
  private HashMap<Agent,Integer> max;
  ...
  */
  public ReplacementRule(int minAge, int maxAge, AgentFactory fac, HashMap<Agent,Integer> max) {
    this.minAge = minAge;
    this.maxAge = maxAge;
    this.fac = fac;
    this.max = max;
...
class ReplacementRuleTester {
  public void test() {
    ...
    int minAge = 40;
    int maxAge = 80;
    HashMap<Agent,Integer> m = new HashMap();
    ReplacementRule rr = new ReplacementRule(minAge, maxAge, af, m);
